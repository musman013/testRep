...
import { WorkspaceListComponent, WorkspaceDetailsComponent, WorkspaceNewComponent } from './workspace/index';
...
const routes: Routes = [
	...
	{ path: 'workspace', component: WorkspaceListComponent, canDeactivate: [CanDeactivateGuard], canActivate: [ AuthGuard ]},
	{ path: 'workspace/new', component: WorkspaceNewComponent, canActivate: [ AuthGuard ] },
	{ path: 'workspace/:id', component: WorkspaceDetailsComponent, canDeactivate: [CanDeactivateGuard], canActivate: [ AuthGuard ] },
